...
const ClientRegistrationComponent = () => {
    ...
    const registrationForm = async (e) => {
        ...
        if (validateForm()) {
            ...
            const user = { firstName, lastName, age, email, city, addressStreet, addressNumber, password }
            ...
            try {
                ...
                // Assign roleId(1) to user
                await assignRoleToUser(createUserResponse.data.id, 1);
                navigator('/');
            } catch (error) {
                console.error(error);
            }
                ...
                <div className='row'>
                    <div className='card col-md-5 mx-auto'>
                        <div className='card-body customs-card'>
                            <h2 className='text-center mb-1 mb-4 mt-2' style={{ fontWeight: 'bold' }}>Client registration</h2>
                            <form>
                                <div className='row'>
